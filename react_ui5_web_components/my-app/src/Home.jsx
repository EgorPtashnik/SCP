...
export const Home = () => {
  ...
  <FlexBox justifyContent={FlexBoxJustifyContent.Center} wrap={FlexBoxWrap.Wrap}
    ...
    <MyCustomElement/>
    <Card heading='Stock Price' style={{ width: '300px', ...spacing.sapUiContentPadding }} headerInteractive
    ...
    <Card heading='AnalyticalTable' style={{maxWidth: '900px', ...spacing.sapUiContentPadding}}
